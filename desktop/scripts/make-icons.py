...
parser.add_argument("--badge", default="chart", choices=["tag", "chart", "shield", "none"])
parser.add_argument("--badge-color", default="#0F766E",
                    help="badge circle colour (this app: insights teal)")
