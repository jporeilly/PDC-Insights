...
the spec schema and the Analytics nav. Every section ships **three** built-in
dashboards — **18 in all**, generated by `tools/build_dashboards.py` and
listed in `app/dashboards/index.json`.
...
Built-ins: *Catalog health* · *Risk hotspots* · *Executive scorecard*.
...
Built-ins: *Profiling health* · *Source inventory* · *Scan operations*.
...
Built-ins: *Stewardship* · *Activity & ratings* · *Contribution pulse*.
...
Built-ins: *Glossary coverage* · *Policy & lineage* · *Governance SLA*.
...
Built-ins: *Quality scores* · *DQ dimensions* · *Quality posture*.
...
Built-ins: *Exposure overview* · *PII discoveries* · *Protection controls*.
